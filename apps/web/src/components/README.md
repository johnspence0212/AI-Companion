...
| Need                        | Do this                                                                                                                                        |
| --------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- |
| Use chrome in a view/module | `import { PageBody, WorkbenchPanes, WorkbenchComposer, WorkbenchSearch, WorkbenchInbox, NotesTree, MarkdownSource, SavedViewBar } from '@/ui'` |
